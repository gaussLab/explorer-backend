...
public class GaussUtil {
    public  static String url="http://192.168.2.126:9317";


    public static void main(String[] args) {
//        txSeach(0,1000);
//        JSONObject json=new JSONObject();
//        JSONArray array=txSeach(5201664,5203308);
//
//        for (int i = 0; i < array.size(); i++) {
//            JSONObject tx=array.getJSONObject(i);
//            if(tx.getString("code")!=null){
//                System.out.println(tx.getString("txhash")); ;
//                System.out.println(tx);
//            }
//        }
        System.out.println( getBalanceByCoin("gauss16qz2vqw6ze3ngyhdcuaghhkdfq4jcnvc0rqed0"));
//        System.out.println(getBalanceByCoin("cosmos1qc6erpwu675cv0yn6tssvrf65y04wh49dkeu4c"));
...
//        query=1&prove=true&page=1&per_page=30&order_by=desc
    ...
    public static BigDecimal getBalanceByCoin(String address){
        String uri=url+"/gauss/bank/v1beta1/balances/"+address+"/ugauss";
        String res=HttpUtils.httpGet(uri);
